...
class IntroTraditionSelectScreen extends StatefulWidget {
  const IntroTraditionSelectScreen({super.key});

  @override
  State<IntroTraditionSelectScreen> createState() =>
      _IntroTraditionSelectScreenState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'What\'s your Christian tradition?',
