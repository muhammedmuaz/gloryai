...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutesNames.calendarScheduleAlarmScreen:
        return _slideRoute(
          screen: const CalendarScheduleAlarmScreen(),
          direction: AxisDirection.left,
        );
      case AppRoutesNames.notificationListScreen:
        return _slideRoute(
